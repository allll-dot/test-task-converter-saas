...
Для appointment_status используй booked, только если во время звонка явно
согласованы запись, дата или время; rescheduled — если существующую запись
перенесли; cancelled — если отменили; not_booked — если запись обсуждали, но не
оформили; not_applicable — если запись не относится к теме звонка; unknown — если
по транскрипту нельзя сделать вывод. Не считай обещание перезвонить записью."""
